...
return (
  <>
    <div className="about" id="about">
      ...
      <div className="bn text-black text-center mt-5">
          ...
          <div className="col-md-3 col-sm-6">
            <div className="card">
              ...
              <div className="card-body text-center mt-3 bdy">
                ...
                <button className="btn d-block mx-auto">View Profile</button>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-3 col-sm-6">
            <div className="card">
              ...
              <div className="card-body text-center mt-3 bdy">
                ...
                <p className="description px-3">
                  An IT student who sees technology as a tool to turn small
                  ideas into big possibilities
                </p>
                <button className="btn  d-block mx-auto">View Profile</button>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="card-body text-center mt-3 bdy ">
                ...
                <p className="description px-3 mt-3">
                  I enjoy exploring problem-solving through technology and
                  system management to prepare for a future career in the I.T.
                  field.
                </p>
                <button className="btn  d-block mx-auto">View Profile</button>
              </div>
